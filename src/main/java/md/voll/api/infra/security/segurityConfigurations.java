...
public class segurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
       return httpSecurity.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
               ...
               .and().authorizeHttpRequests().requestMatchers(HttpMethod.DELETE, "/medicos").hasRole("ADMIN")
               .and().authorizeHttpRequests().requestMatchers(HttpMethod.DELETE, "/paciente").hasRole("ADMIN")
